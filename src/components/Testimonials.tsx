...
export function Testimonials() {
  return (
    <section
      ...
      className="bg-slate-50 py-20 dark:bg-slate-900 sm:py-32"
    >
      <Container>
              ...
              <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
                {column.map((testimonial, testimonialIndex) => (
                  <li key={testimonialIndex}>
                    <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10 dark:bg-slate-800">
